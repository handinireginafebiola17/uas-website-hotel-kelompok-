            ...
            <div class="row">
                ...
                <div class="small-box text-bg-primary">
                  <div class="inner">
                    <?php
                        ...
                        $sql = mysqli_query($koneksi,"SELECT sum(jumlah) as jml FROM tbl_barang");
                        $data = mysqli_fetch_array($sql);
                        ?>
                    <h3><?=$data['jml']?></h3>

                    <p>Data Jumlah Barang</p>
                  </div>
                  <svg
                  ...
                  <a
                    href="dashboard.php?menu=barang"
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box text-bg-success">
                  <div class="inner">
                  <?php
                        $sql = mysqli_query($koneksi,"SELECT COUNT(*) as total FROM tbl_customer");
                        $data = mysqli_fetch_array($sql);
                        ?>
                        <h3><?=$data['total']?></h3>
                        <p>Data Jumlah Customer</p>
                  </div>
                  <svg
                    class="small-box-icon"
                    fill="currentColor"
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box text-bg-warning">
                  <div class="inner">
                  <?php
                        $sql = mysqli_query($koneksi,"SELECT COUNT(*) as total FROM tbl_transaksi");
                        $data = mysqli_fetch_array($sql);
                        ?>
                        <h3><?=$data['total']?></h3>
                        <p>Data Jumlah Transaksi</p>
                  </div>
                  <svg
                    class="small-box-icon"
                    fill="currentColor"
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box text-bg-danger">
                  <div class="inner">
                  <?php
                        $sql = mysqli_query($koneksi,"SELECT COUNT(*) as total FROM tbl_login");
                        $data = mysqli_fetch_array($sql);
                        ?>
                        <h3><?=$data['total']?></h3>
                        <p>Data User Login</p>
                  ...
                  <a href="dashboard.php" class="small-box-footer" title="Data user login bersifat internal sistem">
  Internal System <i class="fas fa-info-circle"></i>
</a>
